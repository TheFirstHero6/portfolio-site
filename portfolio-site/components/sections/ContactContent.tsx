...
export function ContactContent() {
  return (
    <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-16 xl:gap-20">
      ...
      >
        <div className="p-5 sm:p-6 md:p-8 rounded-2xl glass-card relative">
          <h3 className="text-white mb-4 sm:mb-5 md:mb-6 font-semibold text-base sm:text-lg">
            Let's Connect
          </h3>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            {socialLinks.map((link, index) => (
              <motion.a
                ...
                style={{
                  borderColor: `${
                    link.gradient.includes("purple") ? "#ec489960" : "#ec489960"
                  }`,
              ...
              >
                ...
                <div className="relative z-10 flex flex-col items-center gap-1.5 sm:gap-2">
                  <link.icon className="text-white group-hover:text-pink-300 transition-colors w-5 h-5 sm:w-6 sm:h-6" />
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${link.gradient} opacity-0 group-hover:opacity-100 blur-xl transition-opacity -z-10`}
                />
              </motion.a>
            ))}
          </div>
        ...
        {/* Footer */}
        <div className="text-center p-3 sm:p-4 rounded-xl glass-card">
