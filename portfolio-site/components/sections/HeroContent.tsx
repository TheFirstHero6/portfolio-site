  ...
  return (
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      >
        {/* Code Terminal */}
        <div 
          className="p-6 rounded-2xl bg-black/80 backdrop-blur-2xl border-2 font-mono relative"
          style={{
        ...
        >
          ...
          <div className="text-sm text-blue-400 min-h-[24px]">
        ...
        <div>
          <motion.h1
            ...
            className="mb-6"
          >
            <span className="block text-white font-semibold mb-2">I'm</span>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white flex items-center gap-2 group"
              onClick={() => {
                if (onNavigate) {
                  onNavigate('projects');
                }
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 rounded-xl bg-black/60 backdrop-blur-xl border-2 border-white/30 text-white hover:bg-black/80 transition-all flex items-center gap-2"
              style={{
        ...
        >
          {["React", "Next.js", "TypeScript", "Tailwind", "Node.js"].map((tech, index) => (
            <motion.div
              ...
              className="px-4 py-2 rounded-full bg-black/60 backdrop-blur-xl border border-blue-500/40 text-white text-sm"
              style={{
      ...
      >
        <div 
          className="p-8 rounded-2xl bg-black/70 backdrop-blur-2xl border-2 space-y-6 relative"
          style={{
            borderColor: '#3b82f660',
        ...
        >
          <div className="text-center mb-8">
            ...
            <h3 className="text-white mb-2">Full Stack Developer</h3>
            <p className="text-white/60 text-sm">Building modern web experiences</p>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div
                ...
                whileHover={{ x: 8 }}
                className="p-4 rounded-xl bg-black/50 backdrop-blur-xl border border-white/20 flex items-center justify-between group"
                style={{
                  boxShadow: '0 0 15px rgba(59, 130, 246, 0.2)',
                }}
              >
                <span className="text-white/70 text-sm">{stat.label}</span>
                <span className={`text-xl bg-clip-text text-transparent bg-gradient-to-r ${stat.color} group-hover:scale-110 transition-transform`}>
                  {stat.value}
                </span>
              </motion.div>
            ))}
          ...
          <motion.div
            className="p-4 rounded-xl bg-gradient-to-br from-blue-500/20 to-purple-500/20 border-2"
            style={{
              borderColor: '#3b82f660',
